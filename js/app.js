...
const cachedElements = {
  ...
  counterElement: document.querySelector(".loader__count .count__text")
};
...
function startLoader() {
  ...
  function updateCounter() {
    if (currentValue < 100) {
      ...
      cachedElements.counterElement.textContent = currentValue;
...
function hideLoader() {
  ...
  setTimeout(() => {
    cachedElements.loader.classList.add("loaded");
  }, 3200);
}

function pageAppearance() {
  gsap.set(cachedElements.loadingItems, { opacity: 0 })
  gsap.to(cachedElements.loadingItems, { 
    duration: 1.1,
    ease: 'power4',
    startAt: {y: 120},
    y: 0,
  ...
  gsap.set(cachedElements.fadeInItems, { opacity: 0 });
  gsap.to(cachedElements.fadeInItems, { duration: 0.8, ease: 'none', opacity: 1, delay: 3.2 });
}
// --------------------------------------------- //
...
// إضافة مراقب إضافي للتأكد من عمل ScrollSpy
document.addEventListener('DOMContentLoaded', function() {
  // إعادة تهيئة ScrollSpy
...
$(function() {
  ...
  // --------------------------------------------- //
  // Contact Form - تم إزالته لاستخدام EmailJS بدلاً من PHP
  // --------------------------------------------- //
